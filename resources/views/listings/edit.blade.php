<x-layout>
  <x-card class="p-10 max-w-lg mx-auto mt-24">
    <header class="text-center">
      <h2 class="text-2xl font-bold uppercase mb-1">Ajouter une réservation/h2>
    ...
    <form method="POST" action="/listings/{{$listing->id}}" enctype="multipart/form-data">
      ...
      @method('PUT')
      <div class="mb-6">
        <label for="company" class="inline-block text-lg mb-2">Nom</label>
      ...
      <div class="mb-6">
        <label for="location" class="inline-block text-lg mb-2">Lieux de reservation</label>
