<x-layout>
  <x-card class="p-10 max-w-lg mx-auto mt-24">
    ...
    <form method="POST" action="/listings" enctype="multipart/form-data">
      ...
      <div class="mb-6">
        <label for="location" class="inline-block text-lg mb-2"> votre Localisation</label>
        <input type="text" class="border border-gray-200 rounded p-2 w-full" name="location"
          placeholder="Example: Cotonou-Bénin" value="{{old('location')}}" />
      ...
      <div class="mb-6">
        ...
        <input type="text" class="border border-gray-200 rounded p-2 w-full" name="tags"
          placeholder="Example: Essence" value="{{old('tags')}}" />
      ...
      <div class="mb-6">
        ...
        <textarea class="border border-gray-200 rounded p-2 w-full" name="description" rows="10"
          placeholder="véhicule 2022 confortabl...">{{old('description')}}</textarea>
