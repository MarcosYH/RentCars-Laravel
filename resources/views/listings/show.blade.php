      ...
      <div class="flex flex-col items-center justify-center text-center">
        ...
        <div>
          ...
          <div class="text-lg space-y-6">
            ...
            <a href="/listings/create" target="_blank"
              class="block bg-black text-white py-2 rounded-xl hover:opacity-80"><i class="fa-solid fa-shop"></i>
             Louer</a>
          </div>
        </div>
      </div>
